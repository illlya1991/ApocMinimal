...
public class TechniqueDefinition
{
    ...
    public int  TerminalLevel { get; init; } = 1;
...
public static class TechAbilityCatalog
{
    ...
    public static readonly TechniqueDefinition[] Techniques =
    {
        ...
        new() { Id="tdef_str1",   Name="Укрепление тела",
            ...
            Kind=TechKind.Passive, TerminalLevel=1, BuyCost=60,
            StatBonus=new(){ [1]=5 } },
        ...
        new() { Id="tdef_strike", Name="Удар силы",
            ...
            Kind=TechKind.Active, TerminalLevel=1, BuyCost=80,
        ...
        new() { Id="tdef_focus2", Name="Острый фокус",
            ...
            Kind=TechKind.Passive, TerminalLevel=2, BuyCost=100,
        ...
        new() { Id="tdef_heal",   Name="Исцеление энергией",
            ...
            Kind=TechKind.Active, TerminalLevel=2, BuyCost=140,
        ...
        new() { Id="tdef_sense",  Name="Сенсорика",
            ...
            Kind=TechKind.Active, TerminalLevel=2, BuyCost=110,
        ...
        new() { Id="tdef_dodge",  Name="Уклонение",
            ...
            Kind=TechKind.Active, TerminalLevel=2, BuyCost=120,
        ...
        new() { Id="tdef_regen3", Name="Быстрое восстановление",
            ...
            Kind=TechKind.Passive, TerminalLevel=3, BuyCost=180,
        ...
        new() { Id="tdef_shield", Name="Щит энергии",
            ...
            Kind=TechKind.Active, TerminalLevel=3, BuyCost=220,
        ...
        new() { Id="tdef_blast",  Name="Взрыв энергии",
            ...
            Kind=TechKind.Active, TerminalLevel=4, BuyCost=300,
